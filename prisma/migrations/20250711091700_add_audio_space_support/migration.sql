...
-- CreateIndex
CREATE UNIQUE INDEX "Invite_spaceId_invitedId_key" ON "Invite"("spaceId", "invitedId");

-- CreateIndex
CREATE INDEX "SpaceSession_spaceId_userId_idx" ON "SpaceSession"("spaceId", "userId");
...
-- AddForeignKey
ALTER TABLE "SpaceSession" ADD CONSTRAINT "SpaceSession_spaceId_fkey" FOREIGN KEY ("spaceId") REFERENCES "Space"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SpaceSession" ADD CONSTRAINT "SpaceSession_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
